...
# TIMES BETWEEN 0.8 AND 1.0 ============================================================================================
# high_indices = np.asarray((0.8 <= relative_points) & (relative_points <= 1)).nonzero()[0]
# print('TIMES BETWEEN 0.8 AND 1.0 INCLUSIVE ===============')
...
#
# ax.set(title='Figure 8: Coverage over April 2022', ylabel='Coverage')
...
ax.hist(bins[:-1], bins, weights=counts, rwidth=1, log=True)

plt.savefig('plots_for_slide/figure7.png', dpi=300, backend='AGG')
